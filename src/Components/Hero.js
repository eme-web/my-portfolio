...
export const Hero = () => {
  return (
    <section id="hero" className="bg-gradient-to-t from-gray-600 via-gray-700 to-gray-800">
        ...
        <div className="text-center lg:text-left flex flex-col lg:justify-center">
          <div className="flex flex-col gap-6 my-auto lg:pl-20">
            <div>
              ...
              <h1 className="text-5xl font-bold md:text-6xl lg:text-7xl xl:text-8xl"> Eme Udobong</h1>
              <h2 className="lg:text-xl mt-4 text-slate-300">Backend Developer</h2>
            </div>
            <SocialMediaIcons />
            <LinkBtn 
            link={resume}
