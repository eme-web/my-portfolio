                        ...
                        return (
                            <div key={project.id} className="flex flex-col shadow-2xl bg-gray-900 rounded md:hover:scale-105 md:hover:bg-stone-900 duration-200">
                                ...
                                <div className="px-8 py-10 flex flex-col gap-4">
                                    <h3 className="text-2xl lg:text-3xl font-bold text-cyan-500">{project.projectName}</h3>
                                    <h4>
                                    ...
                                    <div className="flex gap-4">
                                        <LinkBtn
                                            classes={"bg-slate-200 text-black font-bold px-6 py-2 rounded hover:bg-gray-400 duration:200"}
                                            linkText="Open"
                                            link={project.projectLink}
                                            icon={faArrowUpRightFromSquare} 
                                        />
                                           <LinkBtn
                                            classes={"bg-gray-700 px-6 py-2 rounded hover:bg-cyan-800 duration:200"}
                                            linkText="Github"
