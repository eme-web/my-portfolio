    ...
    return (
        <section id="about" className="bg-gray-800">
            <div className="container mx-auto px-12 py-40">
                <h2 className="text-3xl lg:text-5xl font-bold text-center lg:text-left" >About Me</h2>
                <div className="text-center lg:text-left flex flex-col lg:flex-row gap-16">
                    <div className="flex flex-col gap-6">
                        <p className="mt-8 text-center lg:text-left text-slate-300">
                            My name is{" "}
                            <strong className="text-cyan-400">Eme Udobong</strong> and I like to <span className="text-cyan-400">design</span> and{" "} 
                            <span className="text-cyan-400">build</span> things for the web.
                        </p>
                        <h3 className="text-xl md:text-2xl lg:text-3xl font-semibold">Education</h3>
                        <div className="flex flex-col gap-6">
                            {education.map((edu) => {
                                return (
